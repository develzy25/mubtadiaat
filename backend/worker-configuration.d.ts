/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 59c45f74e5cbcc99047631a0830d912e)
// Runtime types generated with workerd@1.20260701.1 2026-07-01 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	DB: D1Database;
	BETTER_AUTH_SECRET: "super-secret-key-for-development-only";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "CLOUDINARY_CLOUD_NAME" | "CLOUDINARY_API_KEY" | "CLOUDINARY_API_SECRET">> {}
}
